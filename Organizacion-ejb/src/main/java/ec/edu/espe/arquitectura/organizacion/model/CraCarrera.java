 ...
 */
@Entity
@Table(name = "cra_carrera")
public class CraCarrera implements Serializable {
    ...
    public CraCarrera(String codigo) {
        this.codigo = codigo;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof CraCarrera)) {
            return false;
        }
        CraCarrera other = (CraCarrera) object;
